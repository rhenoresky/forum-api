...
describe('CommentRepository interface', () => {
  it('should throw error when invoke abstract behavior', async () => {
    ...
    await expect(commentRepository.submitComment({})).rejects.toThrowError('COMMENT_REPOSITORY.METHOD_NOT_IMPLEMENTED');
    ...
    await expect(commentRepository.checkCommentBelongsToThread({})).rejects.toThrowError('COMMENT_REPOSITORY.METHOD_NOT_IMPLEMENTED');
  });
});
